...
export const metadata: Metadata = {
  ...
  description:
    "Evde bakım maaşı ön değerlendirmesinde toplam hane geliri ve kişi sayısının neden istendiğini açıklayan yardımcı rehber sayfa.",
  alternates: {
...
const notes = [
  ...
  "Frontend yalnızca rehberlik amacıyla özet gösterir.",
  "Kesin threshold yorumu backend motoru tarafından yapılır.",
];
      ...
      <div className="mx-auto max-w-5xl">
        <section className="card-panel">
          ...
          <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-700">
            ...
            değerlendirme için temel giriş alanları arasındadır. Ancak burada görülen özetler resmi
            threshold kararı değildir.
          </p>
          ...
          <article className="card-panel">
            ...
            <div className="mt-4 space-y-4 text-sm leading-7 text-slate-700">
              <p>
                ...
                ekranı bu iki veriyi birlikte ister ve kullanıcıya yalnızca rehberlik amaçlı kısa bir
                kontrol adımı sunar.
              </p>
              <p>
                Nihai uygunluk ya da uygunsuzluk sonucu frontend tarafından hesaplanmaz. Backend,
                policy kuralları ve testli threshold davranışı ile authoritative değerlendirme yapar.
              </p>
            </div>
          </article>
